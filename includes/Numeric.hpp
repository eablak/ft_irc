...
#define ERR_INPUTTOOLONG() ("417 :Input line was too lon")
#define ERR_PASSWDMISMATCH() ("464 :Password incorrec")
#define ERR_NONICKNAMEGIVEN() ("431 :No nickname give")
#define ERR_ERRONEUSNICKNAME(nick) ("432 " + nick + " :Erroneus nicknam")
#define ERR_UNKNOWNCOMMAND(cmd) ("421 " + cmd + " :Unknown comman")
#define ERR_ALREADYREGISTRED() ("462 :You may not reregiste") // USER veya PASS'i bi daha gönderirse
